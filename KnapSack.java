...
public class KnapSack
{
	public static void main(String[] args)
	{
		...
		KnapsackBBSolver1 BBSolver1 = new KnapsackBBSolver1(UPPER_BOUND.UB1); //branch-and-bound solver with UB1
		KnapsackBBSolver1 BBSolver2 = new KnapsackBBSolver1(UPPER_BOUND.UB2); //branch-and-bound solver with UB2
	    KnapsackBBSolver1 BBSolver3 = new KnapsackBBSolver1(UPPER_BOUND.UB3); //branch-and-bound solver with UB3
	    KnapsackBBSolver1 BBSolver4 = new KnapsackBBSolver1(UPPER_BOUND.UB3); //branch-and-bound solver with UB3
		...
		System.out.printf("\nSpeedup of BB-UB2 enhanced  relative to BF is"+speedup+"percent");
